...
public class TestFrame extends JFrame {	
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3957694268599338642L;
	...
	public TestFrame(String title,String url) throws HeadlessException {
		super(title);
		...
		topPanel.add(new JLabel("file location: "), BorderLayout.WEST);
